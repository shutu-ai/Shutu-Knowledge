...
Status: **Phase 0 (source audit) complete; implementation in progress.** See [Agent.md](Agent.md) for the work plan and [docs/](docs) for audit and design documents.
...
TBD (Phase 1 decision). See [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md) for the reference-project policy.
