...
const zh = {
  ...
  "Testing configuration": "正在测试配置",
  "Test passed": "测试通过",
  "Test failed": "测试失败",
  "dimensions": "维度",
  "scores": "评分",
  "Loading": "加载中",
  "Loading page data": "正在读取页面数据，请稍候…",
  "Loading document list": "正在读取文档列表…",
  "Unable to load page": "页面加载失败",
  "Request failed": "请求失败",
  ...
  "Name": "名称",
  "Status": "状态",
  "Embedding ready": "Embedding 已完成",
  "Embedding pending": "Embedding 处理中",
  "Lexical only": "仅词法检索",
  "Empty": "空",
  ...
  "Import files": "导入文件",
  "Directory": "目录",
  "Frontend directory": "前台目录",
  "Backend directory": "后台目录",
  "Absolute local path": "本地绝对路径",
  "Import directory": "导入目录",
  "Import frontend directory": "导入前台目录",
  "Import backend directory": "导入后台目录",
  "Text imported": "文本已导入",
  ...
  "Local": "本地",
  "Remote": "远程",
  "Current setting not found locally": "当前配置未在本地找到",
  "Select an installed local model": "从已安装的本地模型中选择",
  "Remote model identifier": "远程模型标识",
  "No installed embedding models": "没有已安装的嵌入模型",
  "No installed rerank models": "没有已安装的重排模型",
  "Embedding local models need no URL": "本地嵌入模型不需要 URL",
  "Rerank local models need no URL": "本地重排模型不需要 URL",
  "Remote URL only; leave blank for local models": "仅远程模式填写；本地模式留空",
  "Local models are selected from the installed model list; URL is only for remote providers.": "本地模型从已安装列表中选择；URL 仅用于远程提供方。",
  "Pull model": "拉取模型",
  ...
  "Self-test running": "自检中",
  "self-test": "模型自检",
  "testing": "自检中",
  "preparing": "准备中",
  "Downloading and loading": "下载与加载中",
  "In progress": "进行中",
  "No exact percentage available": "当前阶段无法提供精确百分比",
  "Model download": "模型下载",
  "Managed runtime cache": "托管运行时缓存",
  "Document tasks": "文档任务",
  "active tasks": "个活动任务",
  "Collapse folder": "收起目录",
  "Expand folder": "展开目录",
  ...
  "Rescanning directory": "重新扫描目录",
  "Importing directory": "导入目录",
  "Parsing file": "解析文件",
  "Embedding file": "生成嵌入",
  "Reindexing file": "重建文件索引",
  "Deleting document": "删除文档",
  "Deleting directory": "删除目录",
  "Reindexing files": "重建文件索引",
  "Processing": "处理中",
  "Waiting for scan count": "等待扫描统计",
  "Waiting for import": "等待导入完成",
  "Cancel": "取消",
  "Download cancelled": "下载已取消",
  "Custom reranker registered": "自定义重排器已注册",
  "Global settings": "全局设置",
  "KNOWLEDGE DEFAULTS": "知识库默认配置",
  "Global": "全局",
  "These defaults apply to every knowledge base unless a base has its own override.": "这些默认配置适用于所有知识库，除非知识库设置了自己的覆盖项。",
  "Models & AI": "模型与 AI",
  "Embedding and reranking providers used by default for new imports and retrieval.": "新文档入库和检索默认使用的嵌入与重排提供方。",
  "Chunking & indexing": "分块与索引",
  "Control how source text is split and prepared for the index.": "控制源文本如何切分并准备进入索引。",
  "Retrieval": "检索",
  "Tune result count, vector search, hybrid fusion, and diversity behavior.": "调整返回数量、向量检索、混合融合和结果多样性。",
  "Document processing": "文档处理",
  "Choose the parser used for difficult files and configure MinerU when enabled.": "选择复杂文件的解析器，并在启用时配置 MinerU。",
  "Workflow & automatic retrieval": "工作流与自动检索",
  "Set conflict handling, URL refresh, and whether the Agent may retrieve automatically.": "设置冲突处理、URL 刷新，以及 Agent 是否允许自动检索。",
  "Image captioning": "图片图注",
  "Optional image-to-text enrichment for documents that contain figures.": "为包含图片的文档提供可选的图片转文字增强。",
  "Runtime & performance": "运行时与性能",
  "Manage local model cache and the amount of background import concurrency.": "管理本地模型缓存和后台导入并发量。",
  "External helpers": "外部辅助工具",
  "Optional command templates for Office conversion, PDF extraction, image decoding, and rendering.": "配置 Office 转换、PDF 提取、图片解码和渲染的可选命令模板。",
  "Save global defaults here; a knowledge-base override takes precedence. Existing vectors may need rebuilding after model changes.": "全局默认配置保存在这里；知识库级覆盖配置优先。模型变更后可能需要重新构建已有向量。",
  ...
  "Configure document analysis and chunking for this knowledge base. Reindex existing documents after changing these settings.": "配置此知识库的文档分析与分块方式。修改后请重新索引已有文档。",
  "Structural analysis": "结构化分析",
  "Inherit global setting": "继承全局设置",
  "Smart structural": "智能结构化",
  "Fixed separator": "固定分隔符",
  "Enabled": "启用",
  "Disabled": "停用",
  "Leave numeric fields blank or 0 to inherit the global value. Semantic chunking requires an available embedding model.": "数值字段留空或填 0 可继承全局值。语义分块需要可用的嵌入模型。",
  "OCR mode": "OCR 模式",
...
const patterns = [
  ...
  [/^(\d+) active tasks?$/, (_, count) => `${count} 个进行中的任务`],
